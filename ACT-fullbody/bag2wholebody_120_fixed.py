...
# ============================================================
DATA_ROOT = Path("/workspace/ACT-wholebody-torque/ACT-wholebody/data/ACT-120")
HF_LEROBOT_HOME = Path("/workspace/ACT-wholebody-torque/ACT-fullbody/data")
REPO_NAME = "ACT-120-V30-fixed"
...
if __name__ == "__main__":
    ...
    print(f"\n{'=' * 60}")
    print(f"Converting ACT-120 to LeRobot format (17D actions)")
